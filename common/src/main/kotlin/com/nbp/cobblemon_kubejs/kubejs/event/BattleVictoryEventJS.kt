...
class BattleVictoryEventJS(
    ...
    val loserPlayers: List<ServerPlayer>
        get() = event.losers
            .flatMap { it.getPlayerUUIDs() }
            .mapNotNull { it.getPlayer() }
    ...
    val loserPlayerUuids: List<String>
    ...
    val hasPlayerWinner: Boolean
        get() = event.winners.any { it.type == ActorType.PLAYER }
}
